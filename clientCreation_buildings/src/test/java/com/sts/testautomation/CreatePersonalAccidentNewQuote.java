...
public class CreatePersonalAccidentNewQuote extends BaseTest {
	...
	@Test(priority = 1, enabled = true, description = "Add new client and Personal Accident")
                ...
                if (currentNode.getKey().equals(Device)) {
                    ...
                    if (currentNode.getValue() instanceof BrowserNode) {
                        ...
                        try {
                        	...
                        	EH = new ExcelHandler(Sheet, "PersonalLiability", 0, 0);
                        ...
                        try {
                    		...
                    		setExcelData(Sheet, i, 1, "PersonalAccidentResults", timeStamp);
                			Thread.sleep(8000);
                		...
                		//	createQuotesBuilding.clickOnPrivatePortfolioCheckbx();
        					...
        					*/
                			Thread.sleep(8000);
        					setExcelData(Sheet, i, 8, "PersonalAccidentResults", createQuotesBuilding.quoteNumber());
        					Thread.sleep(5000);
        			...
        			//		createQuotesBuilding.changeFocusToBrowser();
        					...
        					Thread.sleep(1000);
        					createQuotesBuilding.clickPersonalAccident();        				
        					Thread.sleep(1000);
        					...
        					createQuotesBuilding.enterPersonInsured(EH.getCellValueSpecific(i, "PersonInsured"));
        					createQuotesBuilding.enterDeath(EH.getCellValueSpecific(i, "Death"));
        					createQuotesBuilding.enterDisability(EH.getCellValueSpecific(i, "Disability"));
        					createQuotesBuilding.enterMedicalBenefit(EH.getCellValueSpecific(i, "MedicalBenefit"));
        					...
        					Thread.sleep(8000);
            					...
            					createQuotesBuilding.changeFocus2();
            					Thread.sleep(5000);
            			//		setExcelData(Sheet, i, 19, "PersonalAccidentResults", createQuotesBuilding.basePremiumPC());
            			//		setExcelData(Sheet, i, 20, "PersonalAccidentResults", createQuotesBuilding.finalPremiumPC());
                    		...
                    		setExcelData(Sheet, i, 2, "PersonalAccidentResults", timeStamp2);
