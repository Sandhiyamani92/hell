...
public class CreateCyberNewQuote extends BaseTest {
	...
	@Test(priority = 1, enabled = true, description = "Add new client and cyber")
                ...
                if (currentNode.getKey().equals(Device)) {
                    ...
                    if (currentNode.getValue() instanceof BrowserNode) {
                        ...
                        try {
                        	...
                        	EH = new ExcelHandler(Sheet, "Cyber", 0, 0);
                        ...
                        try {
                    		...
                    		setExcelData(Sheet, i, 1, "CyberResults", timeStamp);
                			Thread.sleep(8000);
                		...
                		//	createQuotesBuilding.clickOnPrivatePortfolioCheckbx();
        					...
        					*/
                			Thread.sleep(8000);
        					setExcelData(Sheet, i, 8, "CyberResults", createQuotesBuilding.quoteNumber());
        					Thread.sleep(5000);
        					...
        					Thread.sleep(1000);
        					createQuotesBuilding.clickCyber();
        					Thread.sleep(1000);
        					createQuotesBuilding.clickAddNewItem();
        					Thread.sleep(1000);
        					createQuotesBuilding.changeFocus2();
        					Thread.sleep(1000);
        					createQuotesBuilding.enterCyberPackage(EH.getCellValueSpecific(i, "Package"));
        					
        					if(EH.getCellValueSpecific(i, "includeSpouse").equalsIgnoreCase("1"))
        					{
        						createQuotesBuilding.clickIncludeSpouse();
        						
        					}
        					if(EH.getCellValueSpecific(i, "includeChildren").equalsIgnoreCase("1"))
        					{
        						createQuotesBuilding.clickIncludeChildren();
        					...
        					Thread.sleep(10000);
            					...
            					createQuotesBuilding.changeFocus2();
            					Thread.sleep(5000);
            				//	setExcelData(Sheet, i+1, 20, "CyberResults", createQuotesBuilding.finalPremiumCyber());
                    		...
                    		setExcelData(Sheet, i, 2, "CyberResults", timeStamp2);
