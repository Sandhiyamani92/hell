...
public class CreatePersonalLiabilityNewQuote extends BaseTest {
	...
	@Test(priority = 1, enabled = true, description = "Add new client and Personal Liability")
                ...
                if (currentNode.getKey().equals(Device)) {
                    ...
                    if (currentNode.getValue() instanceof BrowserNode) {
                        ...
                        try {
                    		...
                    		setExcelData(Sheet, i, 1, "PersonalLiabilityResults", timeStamp);
                			Thread.sleep(8000);
                		...
                		//	createQuotesBuilding.clickEditQuote();
        					...
        					*/
                			Thread.sleep(8000);
        					setExcelData(Sheet, i, 8, "PersonalLiabilityResults", createQuotesBuilding.quoteNumber());
        					Thread.sleep(5000);
        			...
        			//		createQuotesBuilding.changeFocusToBrowser();
        					...
        					Thread.sleep(1000);
        					createQuotesBuilding.clickPersonalLiability();        				
        					Thread.sleep(1000);
        					createQuotesBuilding.clickAddNewItem();
        					Thread.sleep(1000);
        					createQuotesBuilding.changeFocus2();
        					Thread.sleep(1000);
        					createQuotesBuilding.enterPersonalLiabilitySumInsured(EH.getCellValueSpecific(i, "sumInsured"));
        					
        					createQuotesBuilding.enterPersonalLiabilityBusinessLiability(EH.getCellValueSpecific(i, "businessLiability"));
        					...
        					Thread.sleep(10000);
            					...
            					createQuotesBuilding.changeFocus2();
            					Thread.sleep(5000);
            					setExcelData(Sheet, i, 19, "PersonalLiabilityResults", createQuotesBuilding.basePremiumPC());
            					setExcelData(Sheet, i, 20, "PersonalLiabilityResults", createQuotesBuilding.finalPremiumPC());
                    		...
                    		setExcelData(Sheet, i, 2, "PersonalLiabilityResults", timeStamp2);
