...
//
//public class Buildings extends BaseTest{
//
...
//									String password = "zuSisESvzC3YKvB!";
...
//									Thread.sleep(5000);
//									//	System.out.println(PolicyNumber););
//									//write_Extracted_rule_to_Sheet("C:\\Users\\NathanielS\\Documents\\GitHub\\Hollard_Earnix_Tial\\src\\Tial_FrontEnd Fields.xlsx", "Buildings Test cases", i, 72, PolicyNumber);
//									Thread.sleep(1000);
...
//									captureTestCaseScreenshotBuildingDetails(i);
//									;
//									Thread.sleep(1000);
//									//	householdContents_GeneralDetails.clicktypeOfPremises();
//									//	householdContents_GeneralDetails.SelectOption("Secure Complex");
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i, "Complex/Estate/Village");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i, "Alarm linked to 24-hour armed response");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i, "Burglar bars fitted to all opening windows louvres and skyline");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i, "Electric fence ");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i, "Security gates fitted to all exiting doors ");
//									}
//
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Basic excess waiver");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Chimneys warranty/guarantee");
//									}
//
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Limited cover – Theft excluded");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Limited cover – Storm and fire excluded");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Noting the interest of financial institution ");
//									}
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshotExtensions(i,"Garden and landscaping - extended cover","Garden and landscaping - extended cover - sum insured ");
//									}
//									Thread.sleep(2000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshotExtensions(i ,"Power Surge ","Power Surge - sum insured");
//									}
//									Thread.sleep(2000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshotExtensions(i,"Subsidence , landslip and heave  - extended cover","Subsidence , landslip and heave - extended cover - sum insured");
//
//									}
//
//
...
//									buildingsAdditionalInfo.selectAmountOfClaimsZeroToTwelve_dd(EH1.getCellValueSpecific(i, "0-12 Months "));
//
//									Thread.sleep(1000);
...
//									 captureTestCaseScreenshotClaims(i);
//									Thread.sleep(1000);
//									userDiary_Nav.clickNext();
//
//									//Thread.sleep(2000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Fire retardant (SABS)");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Lightning Conductor (SABS)");
//									}
//
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Surge protection (SANS)");
//									}
//									Thread.sleep(1000);
...
//										Thread.sleep(2000);
//										captureTestCaseScreenshot(i,"Geo Tech / Eng Report ? ");
//									}
//
//
//
...
//									userDiary_Nav.clickBuildingsContentsNextButton();
//
//										if (EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase("Number of Geysers")||EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase("Geyser Sum Insured")
//										||EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase("Geyser Size ")||EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase("Geyser Manufacturer")) {
//											householdContents_GeneralDetails.clickAddGeyserBtn();
//											householdContents_GeneralDetails.clickGeyserTypeDropDown();
//											householdContents_GeneralDetails.SelectOption("Electrical");
//											Thread.sleep(1000);
//											householdContents_GeneralDetails.enterNumberOfGeysers("10");
//											Thread.sleep(1000);
//											//householdContents_GeneralDetails.enterGeyserSize(geyserSize[Integer.parseInt(EH1.getCellValueSpecific(i, "Basic excess for policyholder 55 years and older "))]);
//											Thread.sleep(1000);
//											householdContents_GeneralDetails.enterGeyserManufacturers("KWIK");
//											Thread.sleep(1000);
//											householdContents_GeneralDetails.enterGeyserSumInsured("1000");
...
//											Thread.sleep(1000);
//											householdContents_GeneralDetails.clickGeyserTypeDropDown();
//											householdContents_GeneralDetails.SelectOption("None");
//											Thread.sleep(1000);
//											householdContents_GeneralDetails.enterNumberOfGeysers("0");
//											Thread.sleep(1000);
//											householdContents_GeneralDetails.clickSaveGeysers();
//											Thread.sleep(1000);
//										}
...
//									Thread.sleep(1000);
//
//										if (EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase("Bank ")) {
//											userDiary_Nav.clickSecondRoundOptionHouseHold_icon();
//											Thread.sleep(1000);
//											buildingsAdditionalInfo.clickBondHolderTab();
//											Thread.sleep(1000);
//											buildingsAdditionalInfo.clickBankDropDown();
//											//householdContents_GeneralDetails.SelectOption(banks[Integer.parseInt(EH1.getCellValueSpecific(i, "Basic excess for policyholder 55 years and older "))]);
//											//captureTestCaseScreenshotBank(i,banks[Integer.parseInt(EH1.getCellValueSpecific(i, "Basic excess for policyholder 55 years and older "))]);
//											Thread.sleep(1000);
//											userDiary_Nav.clickFirstRoundOptionHouseHold_icon();
//											Thread.sleep(1000);
//										}
//
//
...
//								//	write_Extracted_rule_to_Sheet("C:\\Users\\NathanielS\\Documents\\GitHub\\Hollard_Earnix_Tial\\src\\Tial_FrontEnd Fields.xlsx", "Buildings Test cases", i, 69, "PASSED");
//									//write_Extracted_rule_to_Sheet("C:\\Users\\NathanielS\\Documents\\GitHub\\Hollard_Earnix_Tial\\src\\Tial_FrontEnd Fields.xlsx", "Buildings Test cases", i, 71, date311);
...
//									//write_Extracted_rule_to_Sheet("C:\\Users\\NathanielS\\Documents\\GitHub\\Hollard_Earnix_Tial\\src\\Tial_FrontEnd Fields.xlsx", "Buildings Test cases", i, 69, "FAILED");
//									//write_Extracted_rule_to_Sheet("C:\\Users\\NathanielS\\Documents\\GitHub\\Hollard_Earnix_Tial\\src\\Tial_FrontEnd Fields.xlsx", "Buildings Test cases", i, 71, date31);
//
//									System.out.println(" ");
...
//		String[] RatingInfoFields = new String[]{"Residence Type", "Roof Type", "Wall Type", "Cover Type", "Dwelling Type", "Dwelling Usage", "Type Of Premises", "Perimeter Wall", "Borders", "Occupancy ", "NCB" };
...
//		String[] RatingInfoFields = new String[]{"Geyser Type","Number of Geysers","Geyser Sum Insured","Geyser Size ","Geyser Manufacturer"};
//		for (String RatingInfoField : RatingInfoFields) {
//			if (EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase(RatingInfoField)) {
//				elementFunctionality.captureScreenshotOnDevice("Field Name : " + EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE") + ", Selected option : " +EH1.getCellValue(Integer.toString(i), RatingInfoField));
//				break;
...
//		}
//	}
//	public void captureTestCaseScreenshotClaims(int i) {
//		String[] RatingInfoFields = new String[]{"Claims"};
//		for (String RatingInfoField : RatingInfoFields) {
//			if (EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase(RatingInfoField)) {
//				elementFunctionality.captureScreenshotOnDevice("Field Name : " + EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE") + ", Selected option : " + EH1.getCellValue(Integer.toString(i), RatingInfoField));
//				break;
...
//		String[] RatingInfoFields = new String[]{"Security Items","Endorsement ","UW Questions "  };
//		for (String RatingInfoField : RatingInfoFields) {
//			if (EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase(RatingInfoField)) {
...
//		}
//	}
//	public void captureTestCaseScreenshotBank(int i, String value) {
//		String[] RatingInfoFields = new String[]{"Bank "};
//		for (String RatingInfoField : RatingInfoFields) {
//			if (EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE").equalsIgnoreCase(RatingInfoField)) {
//				elementFunctionality.captureScreenshotOnDevice("Field Name : " + EH1.getCellValue(Integer.toString(i), "TC OBJECTIVE") + ", Selected option : " + value);
//				break;
//			}
//		}
//	}
