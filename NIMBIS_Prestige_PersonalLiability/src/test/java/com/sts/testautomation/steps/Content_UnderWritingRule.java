...
public class Content_UnderWritingRule extends BaseTest {
    ...
    public void UWRule(String URL) throws Exception {
        ...
        nimbisPrestigeContents.enterNumberOfClaimsLast12month(EH.getCellValueSpecific(1, "Number of Personal_Liability claims in the last 12 months"));

        nimbisPrestigeContents.enterNumberOfClaimsLast24month(EH.getCellValueSpecific(1, "Number of Personal_Liability claims in the last 13 to 24 months"));

        nimbisPrestigeContents.enterNumberOfClaimsLast36month(EH.getCellValueSpecific(1, "Number of Personal_Liability claims in the last 25 to 36 months"));
    ...
    @Parameters({"URL"})
    @Test(priority = 5, description = "UR627-Personal_Liability at Home which is a holiday home and no main residence on the same policy")
    public void UR627(String URL) throws Exception {
        ...
        nimbisUserNavigation.changeWarningFrame();
        String warningmsg=   testB.findElement(By.xpath("//div[@id='alert1748804661282_message']")).getText();
        warningmsg.equalsIgnoreCase("Personal_Liability are kept at a holiday home. Because there is no main residence on the same policy. The cover request must be approved by Hollard.");
        nimbisUserNavigation.clickPopUpOkBtn();
        nimbisUserNavigation.clickCloseBtn();
    ...
    @Parameters({"URL"})
    @Test(priority = 6, description = "UR628-Personal_Liability at Home which is not a holiday home and is unoccupied for more than 90 days per year")
    public void UR628(String URL) throws Exception {
        ...
        nimbisUserNavigation.changeWarningFrame();
        String warningmsg=   testB.findElement(By.xpath("//div[@id='alert1748804661282_message']")).getText();
        warningmsg.equalsIgnoreCase("The Personal_Liability are kept in a Home which is not a Holiday Home and is unoccupied for more than 90 days. The cover request must be approved by a manager.");
        nimbisUserNavigation.clickPopUpOkBtn();
        nimbisUserNavigation.clickCloseBtn();
