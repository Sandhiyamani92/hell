...
public class NIMBIS_UserNavigation {
  ...
  //
  @FindBy(xpath = "//a[@id='ctl00_ContentPlaceHolder1_lstResults_ctl00_ctl08_hpHeader' and contains(text(), 'Vukani Shembe')]")
...
catch(Exception e)
{
    ...
    js.executeScript("arguments[0].click();", addNewItemBtn);
}
    }
    ...
    public void selectOption(String option){
      //  WebElement item = BrowserDriver.findElement(By.xpath("//li[contains(normalize-space(.),'" + option +"')]"));;
        WebElement item = BrowserDriver.findElement(By.xpath("//li[contains(@class,'rcb') and normalize-space(text())='" + option + "']"));
