...
public class NIMBIS_Vintage {
    ...
    @FindBy(xpath = "//input[@id='ctl00_ContentPlaceHolder1_DynamicQuestions1_NonStandard_11127']")
    private WebElement uninterrupted_vehicle_insurance;
...
//claims
    ...
    public void  enterUninteruptedcover( String amount) {
        if (verifyElement.verifyBrowserElementValue(uninterrupted_vehicle_insurance, "Claims_12") == 0) {
            verifyElement.sendKeys(uninterrupted_vehicle_insurance,"Claims_12",amount);
        }
    }
    ...
    public void clickaddDriver(){
        if (verifyElement.verifyBrowserElementValue(addDriver_btn, "Add Driver") == 0){
            verifyElement.clickElement(addDriver_btn,"Add Driver");
        }
    }
